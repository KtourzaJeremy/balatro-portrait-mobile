...
function create_UIBox_game_over()
  ...
  local t = create_UIBox_generic_options({ bg_colour = eased_red ,no_back = true, padding = 0, contents = {
    {n=G.UIT.R, config={align = "cm"}, nodes={
      {n=G.UIT.O, config={object = DynaText({string = {localize('ph_game_over')}, colours = {G.C.RED},shadow = true, float = true, scale = G.F_PORTRAIT and 1.2 or 1.5, pop_in = 0.4, maxw = 6.5})}},
    }},
    stats_content
}})
